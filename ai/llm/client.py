...
class LLMClient:
    ...
    async def _is_provider_healthy(self, provider_name: str) -> bool:
        ...
        try:
            ...
            import logging
            logging.getLogger(__name__).debug("provider_health_check_failed", extra={"error": str(health_err)})
            return True
    ...
    async def _mark_provider_unhealthy(self, provider_name: str, ttl_seconds: int = None) -> None:
        ...
        try:
            ...
            import logging
            logging.getLogger(__name__).warning("provider_health_mark_failed", extra={"error": "redis unavailable"})
