...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0F1B2D] py-16 px-6 md:px-8">
        ...
        <div className="space-y-10 text-slate-300 text-sm leading-7">
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-2">2.1 Account data</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-2">2.2 Health and medication data</p>
                <ul className="space-y-1 list-disc list-inside">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-2">2.3 AI interaction data</p>
                <ul className="space-y-1 list-disc list-inside">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-2">2.4 Technical and usage data</p>
                <ul className="space-y-1 list-disc list-inside">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-2">2.5 Audit log data</p>
                <p>
          ...
          <section>
            ...
            <div className="space-y-2">
              <p><strong className="text-white">Providing the service:</strong> Running drug interaction checks, allergy detection, AI queries, reminders, and profile sharing.</p>
              <p><strong className="text-white">Security:</strong> Rate limiting, session management, account lockout, IDOR prevention, and fraud detection.</p>
              <p><strong className="text-white">Communication:</strong> Sending medication reminders, verification emails, and important account notices.</p>
              <p><strong className="text-white">Improving accuracy:</strong> AI feedback (thumbs up/down) is used to identify where our drug knowledge needs improvement. No personal health data is used for AI training without explicit consent.</p>
              <p><strong className="text-white">Legal compliance:</strong> Maintaining audit logs as required by applicable law.</p>
            </div>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">Users you authorize</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">AI providers — Groq and Google Gemini</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">NeonDB — database infrastructure</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">Sentry — error monitoring</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">PostHog — usage analytics</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">Law enforcement</p>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">5. How We Protect Your Data</h2>
            <p className="mb-4">We have implemented the following security measures:</p>
            <div className="space-y-2">
              <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                <p className="text-white font-medium text-xs mb-1">Password security</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                <p className="text-white font-medium text-xs mb-1">Session management</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                <p className="text-white font-medium text-xs mb-1">Access control</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                <p className="text-white font-medium text-xs mb-1">Encryption</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                <p className="text-white font-medium text-xs mb-1">PHI protection in logs</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                <p className="text-white font-medium text-xs mb-1">Audit trail</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                <p className="text-white font-medium text-xs mb-1">Input security</p>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">6. Data Storage and International Transfer</h2>
            <p>
              Your data is stored on servers located in the <strong className="text-white">United States</strong>.
          ...
          <section>
            ...
            <div className="space-y-2">
              <div className="flex gap-4 items-start bg-white/5 border border-white/10 rounded-xl p-3">
                <span className="text-slate-400 text-xs w-40 flex-shrink-0">Account and health data</span>
                <span>Retained until you delete your account, at which point it is permanently deleted</span>
              </div>
              <div className="flex gap-4 items-start bg-white/5 border border-white/10 rounded-xl p-3">
                <span className="text-slate-400 text-xs w-40 flex-shrink-0">AI conversation history</span>
                <span>Deleted automatically after 1 hour (stored in Redis with TTL)</span>
              </div>
              <div className="flex gap-4 items-start bg-white/5 border border-white/10 rounded-xl p-3">
                <span className="text-slate-400 text-xs w-40 flex-shrink-0">Session tokens</span>
                <span>Access tokens expire after 30 minutes; refresh tokens after 7 days</span>
              </div>
              <div className="flex gap-4 items-start bg-white/5 border border-white/10 rounded-xl p-3">
                <span className="text-slate-400 text-xs w-40 flex-shrink-0">Audit logs</span>
                <span>Retained indefinitely in pseudonymized form (user UUID only, no personal details after account deletion)</span>
              </div>
              <div className="flex gap-4 items-start bg-white/5 border border-white/10 rounded-xl p-3">
                <span className="text-slate-400 text-xs w-40 flex-shrink-0">Error reports</span>
                <span>Retained for 90 days by Sentry, then automatically deleted</span>
              </div>
              <div className="flex gap-4 items-start bg-white/5 border border-white/10 rounded-xl p-3">
                <span className="text-slate-400 text-xs w-40 flex-shrink-0">Analytics events</span>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">8. Your Rights Under NDPR</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">Right to deletion (right to erasure)</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-medium mb-1">Right to data portability</p>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">9. Cookies and Local Storage</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">11. Medical Disclaimer</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">13. Contact and Complaints</h2>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-2">
              <p><strong className="text-white">Privacy questions and data requests:</strong> <a href="mailto:privacy@pillara.site" className="text-[#4A9B8E] hover:underline">privacy@pillara.site</a></p>
              <p><strong className="text-white">Security issues:</strong> <a href="mailto:security@pillara.site" className="text-[#4A9B8E] hover:underline">security@pillara.site</a></p>
              <p><strong className="text-white">General:</strong> <a href="mailto:hello@pillara.site" className="text-[#4A9B8E] hover:underline">hello@pillara.site</a></p>
            </div>
            <p className="mt-3">
